...
INCLUDE_DIRS +=. . $(PROJ_ROOT)/bsp/stm32f40x $(PROJ_ROOT)/bsp/stm32f40x/Libraries/CMSIS/Include $(PROJ_ROOT)/bsp/stm32f40x/Libraries/CMSIS/ST/STM32F4xx/Include $(PROJ_ROOT)/bsp/stm32f40x/Libraries/STM32F4xx_StdPeriph_Driver/inc $(PROJ_ROOT)/include $(PROJ_ROOT)/bsp/stm32f40x/drivers $(PROJ_ROOT)/bsp/stm32f40x/Drivers_of_HMB_alpha $(PROJ_ROOT)/components/finsh  
LIBRARY_DIRS += 
LIBRARY_NAMES += 
